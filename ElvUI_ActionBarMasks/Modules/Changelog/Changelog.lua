...
local ChangelogTBL = {
	...
	'v1.17 11/1/2022',
		'• toc bump for retail',
		'• fix errors from api changes from df',
	' ',
	'v1.16 8/31/2022',
...
function module:CreateChangelog()
	...
	local header = CreateFrame('Frame', 'ABMChangeLogHeader', frame, 'BackdropTemplate')
	...
	local footer = CreateFrame('Frame', 'ABMChangeLogFooter', frame)
	...
	local scrollBar = _G.ABMChangelogScrollFrameScrollBar
	S:HandleScrollBar(scrollBar, nil, nil, 'Transparent')
	ABMChangelogScrollFrameScrollBarScrollUpButton:SetTemplate('Transparent')
	ABMChangelogScrollFrameScrollBarScrollDownButton:SetTemplate('Transparent')
